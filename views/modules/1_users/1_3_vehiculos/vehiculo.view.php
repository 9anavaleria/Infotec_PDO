...
<body>
    <div class="container">
        ...
        <hr>
            <div class="row tablas">
                <div class="col-md-3">
                    <form method="post" action="?c=Vehiculo" class="row g-3 needs-validation" id="vehiculo" novalidate>
                        ...
                        <input type="text" class="form-control mb-3" id="placa_vehiculo" name="placa_vehiculo" placeholder="Placa Vehiculo">
                        <span id="errorId_placa" style="color: red;"></span>
            ...
            <div class="div col-md-9">
                <table id="tablavehiculo" class="table justify-content-center col-11 ">
                    ...
                    <tbody>
                        <?php foreach ($verVehiculo as $vehiculo){ ?>
                        <tr>
                            <td class="text-center">
    ...
    <script>
        ...
        $(document).ready(function() {
            $("#vehiculo").submit(function(event) {
                var idplaca = $("#placa_vehiculo").val();
                var soloNumeros = /^[a-zA-Z0-9]{6}$/.test(idplaca);

                if (!soloNumeros) {
                    $("#errorId_placa").html("La identificación debe contener solo 6 caracteres.");
        ...
        document.getElementById("vehiculo").addEventListener("submit", function(event) {
        var respuesta = confirm("¿Está seguro de que desea crear el Vehiculo?");
        if (!respuesta) {
            event.preventDefault(); 
        }
        });
